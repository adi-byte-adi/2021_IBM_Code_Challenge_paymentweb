...
let mobile = ["May I know your Registered Mobile Number?"];
let OTP=["An OTP has been send to your mobile number"];
let amt=["You have to Pay Rupees 500"];
let paymentmode=["Which mode of payment do you prefer?"];
